...
def main():
    ...
    args = [
        "--config", get_resource_path("configs", "inference.yaml"),
        "--input_image", get_resource_path("assets.examples", "dicaprio.jpg"),
        "--input_audio", get_resource_path("assets.examples", "speech.wav"),
        "--output_dir", "/tmp/out",
        # "--seed", "1234",
    ]
